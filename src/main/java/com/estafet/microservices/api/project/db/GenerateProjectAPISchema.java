package com.estafet.microservices.api.project.db;
...
public class GenerateProjectAPISchema {

	public static void main(String[] args) throws IOException {
		File create = new File("create-project-api-db.ddl");
		File drop = new File("drop-project-api-db.ddl");
		create.delete();
		drop.delete();
		new ClassPathXmlApplicationContext("project-api-entity-application-context.xml").close();
