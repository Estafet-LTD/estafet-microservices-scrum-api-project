node("maven") {
	...
	stage("build & deploy container") {
		...
		sh "oc set env dc/${microservice} JBOSS_A_MQ_BROKER_URL=tcp://broker-amq-tcp.${project}.svc:61616"
	...
	stage("container tests") {
		try {
			withEnv(
				...
				sh "oc set env dc/${microservice} JBOSS_A_MQ_BROKER_URL=tcp://localhost:61616"
